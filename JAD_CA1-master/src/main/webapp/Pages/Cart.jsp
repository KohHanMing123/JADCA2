    ...
    <div class="h-max mx-64 my-20">
        ...
        <table class="min-w-full bg-white">
            ...
            <tbody>
                ...
                <tr>
                    <td class="py-4 px-6 border-b border-gray-200"><%= book.getTitle() %></td>
                    <td class="py-4 px-6 border-b border-gray-200"><%= book.getAuthor() %></td>
                    <td class="py-4 px-6 border-b border-gray-200 text-right">$<%= book.getPrice() %></td>
                </tr>
                <% } %>
            </tbody>
        </table>

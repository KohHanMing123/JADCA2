...
<body class="bg-sand">
    ...
    <div class="flex flex-wrap justify-center">
        ...
        <!-- Button 3 -->
        <a href="BookList.jsp?genre=Horror" class="w-1/5 h-72 bg-light-blue m-6 rounded-xl flex items-center justify-center">
            <span class="text-black text-3xl font-bold">Horror</span>
        </a>
        <!-- Button 4 -->
        <a href="BookList.jsp?genre=Romance" class="w-1/5 h-72 bg-dark-blue m-6 rounded-xl flex items-center justify-center">
            <span class="text-black text-3xl font-bold">Romance</span>
        </a>
        <!-- Button 5 -->
        <a href="BookList.jsp?genre=Science Fiction" class="w-1/5 h-72 bg-light-blue m-6 rounded-xl flex items-center justify-center">
            <span class="text-black text-3xl font-bold">Sci-Fi</span>
        </a>
        <!-- Button 6 -->
        <a href="BookList.jsp?genre=History" class="w-1/5 h-72 bg-dark-blue m-6 rounded-xl flex items-center justify-center">
            <span class="text-black text-3xl font-bold">History</span>
        </a>
        <!-- Button 7 -->
        <a href="BookList.jsp?genre=Cooking" class="w-1/5 h-72 bg-light-blue m-6 rounded-xl flex items-center justify-center">
            <span class="text-black text-3xl font-bold">Cooking</span>
        </a>
        <!-- Button 8 -->
        <a href="BookList.jsp?genre=Comedy" class="w-1/5 h-72 bg-dark-blue m-6 rounded-xl flex items-center justify-center">
            <span class="text-black text-3xl font-bold">Comedy</span>
        </a>
        
        <!-- Button 9 -->
        <a href="BookList.jsp?genre=Historical Fiction" class="w-1/5 h-72 bg-dark-blue m-6 rounded-xl flex items-center justify-center">
            <span class="text-black text-3xl font-bold">Historical Fiction</span>
        </a>
        
        <!-- Button 10 -->
        <a href="BookList.jsp?genre=Fiction" class="w-1/5 h-72 bg-dark-blue m-6 rounded-xl flex items-center justify-center">

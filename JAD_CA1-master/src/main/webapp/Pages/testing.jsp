...
System.out.println("book ID in testing " + bookID);

SQLqueryBook query = new SQLqueryBook();
Book book = query.getBook(bookID);
System.out.println("Book object test: " + book);

String custID = (String) session.getAttribute("custID");
System.out.println("custOMER in testing.JSP id is " + custID);
...
if (book != null) {
    ...
    response.sendRedirect(request.getContextPath() + "/Pages/testing.jsp");
    return;
}
%>
<!DOCTYPE html>
             ...
             <%-- <tbody>
                ...
                <tr>
                   ...
                   <%
                    	...
                    	System.out.println("cartBookID " + cartBookID);
